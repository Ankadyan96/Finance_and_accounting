...
// three PAS lifecycle rows (Ayushi's deposit, the wire to Vikas & Co, Vikram & Sons's
...
export function FinanceProvider({ children }) {
  ...
  const addJournalEntry = (newEntry) => {
    ...
    const entityName = newEntry.entityName || activeEntity?.name || (currentAccountingLevel === 'pizza' ? "Domino's Franchise Store #12" : 'Vikas & Co');
  ...
  const executeStageAction = (stage) => {
    if (stage === 2) {
      ...
      addJournalEntry({
        ...
        status: 'Draft',
        lines: [
          { accountCode: '1150', accountName: 'Bordereau Ingestion Subledger AR (Vikas & Co)', debit: 29757.00, credit: 0 },
      ...
      addJournalEntry({
        ...
        lines: [
          ...
          { accountCode: '1150', accountName: 'Bordereau Ingestion Subledger AR (Vikas & Co)', debit: 0, credit: 29757.00 }
        ]
      });
      setLifecycleStage(5);
    }
