          ...
          <div className="bi-modal-content">
            ...
            <div className="bi-pdf-doc" style={{ boxShadow: 'none', border: 'none', padding: '12px 0' }}>
              <div className="bi-pdf-head">
                <div className="bi-pdf-brand">
                  <div className="bi-pdf-brand-mark">
                    {(viewingInvoice.carrier || 'Vikram & Sons').slice(0, 2).toUpperCase()}
                  </div>
                  <div>
                    <strong style={{ fontSize: '15px' }}>{viewingInvoice.carrier || 'Vikram & Sons Insurance Co.'}</strong><br />
                    <span style={{ color: 'var(--gray-500)', fontSize: '11px' }}>
                      MGA: {viewingInvoice.mga || 'Vikas & Co'} &bull; Broker: {viewingInvoice.producer || 'Arora & Sons'}
                    </span>
                  </div>
                </div>
              ...
              <div className="bi-pdf-footer">
                Payment due upon receipt. Remit to Vikram & Sons / Vikas & Co referencing invoice number {viewingInvoice.invoiceNumber}.
              </div>
