...
const ROLE_CONFIG = {
  carrier: {
    entity: 'ENT-CAR-01',
    subtitle: 'Vikram & Sons · Reconciliation for the carrier operating account',
    accounts: [
      { key: 'carrierOperating', bankName: 'Chase Commercial', accountNo: '****0874', label: 'Chase Commercial — Vikram & Sons Operating (****0874)' }
    ]
  },
  mga: {
    entity: 'ENT-MGA-01',
    subtitle: 'Vikas & Co · Reconciliation for premium trust & operating accounts',
    accounts: [
      { key: 'mgaTrust', bankName: 'Wells Fargo', accountNo: '****7002', label: 'Wells Fargo — Vikas & Co Premium Trust (****7002)' },
      { key: 'mgaOperating', bankName: 'Chase Commercial', accountNo: '****4821', label: 'Chase Commercial — Vikas & Co Operating (****4821)' }
    ]
  },
  default: {
    entity: 'ENT-AGY-01',
    subtitle: 'Arora & Sons · Reconciliation for premium trust & operating accounts',
    accounts: [
      { key: 'brokerTrust', bankName: 'Wells Fargo', accountNo: '****5561', label: 'Wells Fargo — Arora & Sons Premium Trust (****5561)' },
      { key: 'brokerOperating', bankName: 'Chase Commercial', accountNo: '****9034', label: 'Chase Commercial — Arora & Sons Operating (****9034)' }
    ]
  }
};
