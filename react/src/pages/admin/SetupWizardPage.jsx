...
export default function SetupWizardPage() {
  ...
  /* Step 1: Company */
  const [companyName, setCompanyName] = useState(tenantConfig?.companyName || 'Vikram & Sons');
  const [legalEntity, setLegalEntity] = useState('Vikram & Sons LLC');
  ...
  const DEFAULT_MASTERS = {
    ...
    Carriers: [
      { id: 'CR-01', name: 'Vikram & Sons', naic: 'NAIC-29481', treaty: 'QS-2026-01' },
