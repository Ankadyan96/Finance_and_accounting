        ...
        <div className="page-actions">
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginRight: '8px' }}>
            ...
            <span className="badge badge-navy" style={{ fontSize: '12px', padding: '4px 8px' }}>
              {viewRole === 'carrier' ? 'Carrier (Vikram & Sons)' : `MGA (${activeEntity?.name || 'Vikas & Co'})`}
            </span>
          </div>
      ...
      <div className="stats-row">
        <div className="stat-card">
          ...
          <div className="stat-info">
            <div className="stat-value">{viewRole === 'carrier' ? '1' : 'Vikram & Sons'}</div>
            <div className="stat-label">{viewRole === 'carrier' ? 'Active MGAs' : 'Underwriting Carrier'}</div>
            <div className="stat-change text-muted">
              {viewRole === 'carrier' ? 'Vikas & Co · Program Manager' : 'Vikram & Sons Specialty · DUAA Partner'}
            </div>
          </div>
        </div>
          ...
          <div className="stat-info">
            ...
            <div className="stat-change trend-up">
              {viewRole === 'carrier'
                ...
                : `From Arora & Sons (Broker) · $${ledgerTotals.brokerTotalBilled.toLocaleString('en-US', { minimumFractionDigits: 2 })} total billed`}
            </div>
          </div>
        </div>
        ...
        <div className="form-card" style={{ padding: '20px' }}>
          <div className="table-head-row">
            ...
            <div className="table-head-actions">
              <button className="btn btn-outline btn-sm" onClick={() => showToast('Downloading VikasCo_August2026_Bordereau.xlsx...', 'info')}>
                Download Template
              </button>
              ...
              <tbody>
                {!displayBill ? (
                  ...
                  <tr>
                    ...
                    <td><span className="badge badge-navy">{viewRole === 'carrier' ? displayBill.entityName || 'Vikas & Co' : displayBill.vendor}</span></td>
                    <td>{(displayBill.entityName || 'Vikas & Co').replace(/\s+/g, '')}_{(displayBill.policyNumber || '').replace(/\s+/g, '')}_Bordereau.xlsx</td>
            ...
            <div className="detail-expand-box">
              <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr', gap: '20px' }}>
                <div>
                  ...
                  <div style={{ marginBottom: '4px' }}><strong>File Name:</strong> VikasCo_August2026_Bordereau.xlsx</div>
          ...
          {expandedSplitId && (
            <div className="form-card" style={{ padding: '20px', borderTop: '1.5px solid var(--border)', marginTop: '20px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                <div className="card-title">Summary Engine - BX-2026-0010 (Vikas & Co)</div>
                ...
                <div>
                  ...
                  <div style={{ background: 'var(--bg, #f8fafc)', borderRadius: '8px', padding: '16px' }}>
                    ...
                    <div style={{ borderTop: '1px solid var(--gray-300)', marginTop: '8px', paddingTop: '8px', display: 'flex', justifyContent: 'space-between', fontSize: '14px', fontWeight: 700 }}>
                      <span>Net to Veridex / Vikram & Sons</span>
            ...
            <table className="data-table" style={{ minWidth: '900px' }}>
              ...
              <tbody>
                {!displayBill ? (
                  ...
                  <tr>
                    <td><span className="badge badge-navy">Vikas & Co</span></td>
                    <td>Commercial Trucking</td>
          ...
          <div className="comm-metrics-grid">
            ...
            <div style={{ background: 'var(--green-bg, #f0fdf4)', borderRadius: '8px', padding: '16px', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '11.5px', color: 'var(--green, #15803d)', marginTop: '4px' }}>
                {viewRole === 'carrier' ? 'Net Settled' : 'Producer Commission (Arora & Sons)'}
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px', flexWrap: 'wrap', gap: '8px' }}>
              <div>
                <div className="font-semibold" style={{ fontSize: '14px' }}>
                  {viewRole === 'carrier' ? `${displayBill.entityName || 'Vikas & Co'} - Inbound Settlement` : `${displayBill.vendor} - DUAA Remittance`}
                </div>
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
              {isSettled ? (
                <button className="btn btn-ghost btn-sm" disabled>
                  ✓ {viewRole === 'carrier' ? 'Wire Matched & Reconciled' : 'Remitted to Vikram & Sons'} (${displayBill.amount.toLocaleString('en-US', { minimumFractionDigits: 2 })})
                </button>
              ) : (
                <button
              ...
              <tbody>
                {!displayBill ? (
                  ...
                  <tr>
                    ...
                    <td>Arora & Sons (Insurance Broker)</td>
                    <td className="text-right">1</td>
                    <td className="text-right font-semibold">${ledgerTotals.brokerTotalBilled.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                    <td className="text-right text-green font-semibold">${ledgerTotals.mgaRevenue.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                    <td className="text-right">0.0%</td>
