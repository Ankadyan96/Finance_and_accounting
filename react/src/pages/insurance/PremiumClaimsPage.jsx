...
const INITIAL_PREMIUMS = [
  { id: 'POL-V8NHT', mga: 'Vikas & Co', state: 'TX', lob: 'Commercial Trucking', effectiveDate: '2026-08-20', written: 39260, earned: 19630, unearned: 19630, status: 'Active' },
  ...
  { id: 'POL-TX-2024-8418', mga: 'Vikas & Co', state: 'TX', lob: 'Property', effectiveDate: '2026-03-15', written: 124800, earned: 28050, unearned: 96750, status: 'Active' },
...
const INITIAL_BOUND_POLICIES = [
  { id: 'POL-V8NHT', policyNumber: 'POL-V8NHT', insured: 'Ayushi', mgaName: 'Vikas & Co', lob: 'Commercial Trucking', state: 'TX', premium: 39260, status: 'invoiced', effectiveDate: '2026-08-20' },
  { id: 'POL-40291', policyNumber: 'POL-40291', insured: 'Apex Freight Solutions', mgaName: 'Vikas & Co', lob: 'Inland Marine Cargo', state: 'TX', premium: 14850, status: 'paid', effectiveDate: '2026-08-25' }
];
...
export function PremiumClaimsPage() {
  ...
  const [bpMga, setBpMga] = useState('Vikas & Co');
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '12px' }}>
            ...
            <div>
              ...
              <select className="field-input" value={filterMga} onChange={(e) => setFilterMga(e.target.value)}>
                ...
                <option value="Vikas & Co">Vikas & Co</option>
              ...
              <div className="form-grid-3" style={{ marginTop: '12px' }}>
                ...
                <div>
                  ...
                  <select className="field-input" value={bpMga} onChange={(e) => setBpMga(e.target.value)}>
                    <option value="Vikas & Co">Vikas & Co (Managing General Agent)</option>
              ...
              <div className="pc-pdf-doc">
                <div className="pc-pdf-head">
                  <div className="pc-pdf-brand">
                    ...
                    <div>
                      <strong style={{ fontSize: '15px' }}>Vikram & Sons</strong><br />
                ...
                <div className="pc-pdf-footer">
                  This declarations page is a summary of coverage bound under the above policy number. Terms and conditions are governed by Vikram & Sons
                </div>
