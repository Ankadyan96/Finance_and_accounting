                ...
                <div className="form-grid-3">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. Arora & Sons Commercial Trucking Tiered Plan"
                      value={newPlanName}
            ...
            <div style={{ padding: '16px', background: 'var(--color-bg, #f8fafc)', borderBottom: '1px solid var(--color-border, #e2e8f0)' }}>
              ...
              <div className="form-grid-3">
                <div>
                  ...
                  <input className="field-input" placeholder="e.g. Arora & Sons" value={newTxnProducer} onChange={(e) => setNewTxnProducer(e.target.value)} />
                </div>
                <div>
