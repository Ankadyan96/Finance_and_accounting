...
export function DashboardCfo() {
  ...
  const ENTITIES = [
    { id: 'ENT-01', name: 'Vikram & Sons', type: 'Carrier', baseRev: 720, baseExp: 554 },
    { id: 'ENT-02', name: 'Vikas & Co', type: 'MGA', baseRev: 290, baseExp: 221 },
    { id: 'ENT-03', name: 'Arora & Sons', type: 'Agency', baseRev: 180, baseExp: 112 },
