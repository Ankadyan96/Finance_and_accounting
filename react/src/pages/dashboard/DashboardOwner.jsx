...
export function DashboardOwner() {
  ...
  const ENTITIES = [
    { name: 'Vikram & Sons', type: 'Carrier', rev: '$14,820,400', exp: '$11,411,708', net: '$3,408,692', margin: '23.0%' },
    { name: 'Vikas & Co', type: 'MGA', rev: '$2,590,000', exp: '$1,980,000', net: '$610,000', margin: '23.5%' },
    { name: 'Arora & Sons', type: 'Agency', rev: '$386,110', exp: '$242,000', net: '$144,110', margin: '37.3%' },
