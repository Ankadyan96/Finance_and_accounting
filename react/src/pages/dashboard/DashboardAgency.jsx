...
export function DashboardAgency() {
  ...
  const BOOK_PARTNERS = [
    { name: 'Vikram & Sons', policies: 184, premium: '$1,240,000', commission: '$186,000', rate: '15.0%' },
  ...
  const ALL_RENEWALS = [
    { insured: 'Apex Logistics LLC', partner: 'Vikram & Sons', expiry: '2026-09-02', days: 12, premium: '$24,500', status: 'In Review', window: 30 },
    ...
    { insured: 'Coastal Marine Charter', partner: 'Vikram & Sons', expiry: '2026-10-10', days: 50, premium: '$31,500', status: 'Upcoming', window: 60 },
