...
export function DashboardAuditor() {
  ...
  const AUDIT_EVENTS = [
    { time: '2026-08-30 14:12:08', user: 'Diego Alvarez (mga@gmail.com)', action: 'Bordereau Transmission', details: 'POL-V8NHT production reported to Vikram & Sons Carrier ($33,257.00)', ip: '192.168.1.42', status: 'Verified' },
