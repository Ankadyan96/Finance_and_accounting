...
export function DashboardMga() {
  ...
  const [bdxList, setBdxList] = useState([
    { carrier: 'Vikram & Sons', type: 'Premium Bordereau', period: 'July 2026', due: '2026-08-15', status: 'Submitted' },
    { carrier: 'Vikram & Sons', type: 'Claims Bordereau', period: 'July 2026', due: '2026-08-15', status: 'Reconciled' },
