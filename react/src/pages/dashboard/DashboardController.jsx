...
export function DashboardController() {
  ...
  const ENTITIES = [
    ...
    { id: 'ENT-01', name: 'Vikram & Sons' },
    { id: 'ENT-02', name: 'Vikas & Co' },
    { id: 'ENT-03', name: 'Arora & Sons' },
  ...
  const [jes, setJes] = useState([
    { je: 'JE-2026-0301', entity: 'Vikram & Sons', date: '2026-08-18', memo: 'Accrued commission expense', amount: 184250, by: 'M. Alvarez', status: 'pending' },
    ...
    { je: 'JE-2026-0305', entity: 'Vikram & Sons', date: '2026-08-20', memo: 'Sales tax liability true-up', amount: 8350, by: 'P. Nazari', status: 'draft' },
  ...
  const [elimPairs, setElimPairs] = useState([
    ...
    { pair: 'Links Insurance Agency → Vikram & Sons', amt: 41200, status: 'pending' },
    { pair: 'Vikram & Sons → Starlight Re', amt: 275900, status: 'exception' },
  ]);
      ...
      <div className="page-header">
        <div>
          ...
          <div className="page-subtitle">
            Books management overview · Vikram & Sons &amp; Consolidated Affiliates
          </div>
        </div>
      ...
      <div className="tb-alert">
        ...
        <div style={{ flex: 1 }}>
          ...
          <div className="tb-alert-desc">
            Vikram & Sons trial balance does not tie to the GL control account as of 08/20/2026. Review suspense entries before closing the period.
          </div>
        </div>
