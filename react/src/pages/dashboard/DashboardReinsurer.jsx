...
export function DashboardReinsurer() {
  ...
  const TREATIES = [
    { id: 'QS-2026-01', name: 'Vikram & Sons Commercial Auto Quota Share', cedant: 'Vikram & Sons', type: 'Quota Share (20%)', cededGwp: '$2,964,000', cedingComm: '$592,800', lossRatio: '54.2%' },
    { id: 'XL-2026-02', name: 'Vikram & Sons Property Catastrophe Excess', cedant: 'Vikram & Sons', type: 'Excess of Loss ($5M xs $1M)', cededGwp: '$1,420,000', cedingComm: '$142,000', lossRatio: '32.1%' },
    ...
    <>
      ...
      <div className="filter-bar" style={{ marginBottom: '18px' }}>
        ...
        <select className="filter-select" defaultValue="all">
          ...
          <option value="southlake">Vikram & Sons</option>
