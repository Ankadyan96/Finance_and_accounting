        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <div style={{ fontSize: '12px', color: 'var(--color-muted)', marginTop: '4px' }}>
              Broker: <strong>Arora & Sons</strong> · Underwriter: <strong>Vikram & Sons</strong> · Period: 2026-08-20 to 2027-08-20
            </div>
          </div>
          <div>
            {lifecycleStage === 1 && (
              <button
                ...
                onClick={() => {
                  ...
                  showToast('Premium payment $39,260.00 paid to Retail Broker (Arora & Sons)!');
                }}
              >
