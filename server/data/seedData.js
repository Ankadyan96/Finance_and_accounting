...
// (Ayushi's deposit, the wire to Vikas & Co, Vikram & Sons' net remittance) used to
...
export const SEED_INVOICES = [
  {
    ...
    partnerName: 'Vikram & Sons', partnerType: 'Carrier',
  ...
  },
  {
    ...
    partnerName: 'Vikas & Co', partnerType: 'MGA',
