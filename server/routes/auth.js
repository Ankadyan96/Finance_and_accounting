...
const DEMO_CREDENTIALS = {
  'carrier@gmail.com': {
    password: 'admin@123', role: 'carrier', name: 'Vikram & Sons',
    roleLabel: 'Risk Carrier Underwriting', entityId: 'ENT-CAR-01', entityName: 'Vikram & Sons',
    businessType: 'carrier', businessLabel: 'Risk Underwriting Carrier', avatarColor: '#2563EB', initials: 'VS'
  },
  'mga@gmail.com': {
    password: 'admin@123', role: 'mga', name: 'Vikas & Co',
    roleLabel: 'Managing General Agent (MGA)', entityId: 'ENT-MGA-01', entityName: 'Vikas & Co',
    businessType: 'mga', businessLabel: 'MGA / Program Manager', avatarColor: '#F97316', initials: 'VC'
  },
  'broker@gmail.com': {
    password: 'admin@123', role: 'broker', name: 'Arora & Sons',
    roleLabel: 'Retail Broker & Producer', entityId: 'ENT-AGY-01', entityName: 'Arora & Sons',
    businessType: 'agency', businessLabel: 'Retail Insurance Agency', avatarColor: '#10B981', initials: 'AS'
  },
  'insured@gmail.com': {
...
router.post('/login', async (req, res) => {
  try {
    ...
    if (user && DEMO_CREDENTIALS[trimmedEmail]) {
      const demo = DEMO_CREDENTIALS[trimmedEmail];
      const isStale = user.name !== demo.name
